...
### 1. 🔴 High-priority review V-CHROME-001 — Chrome Safe Browsing enhanced protection must be enabled
...
### 2. 🔴 High-priority review V-CHROME-004 — Chrome extension installation must be restricted

**Impact:** High-priority review · **Owner:** Endpoint/Windows Admin

A new high-severity control was added, so it should be triaged before lower-risk backlog work.

### 3. 🟡 Evidence update likely V-CHROME-002 — Chrome password manager must be disabled

**Impact:** Evidence update likely · **Owner:** Endpoint/Windows Admin

The check procedure changed enough that evidence requests or validation steps may need to be refreshed.

### 4. 🔵 Review recommended V-CHROME-003 — Deprecated Chrome cleanup policy must be reviewed

**Impact:** Review recommended · **Owner:** Security/GRC Analyst
